...
import * as modOperaciones from "./modulos/controller.js"
import chalk from 'chalk';

const operacion1 =  modOperaciones.suma(1,2);
console.log(operacion1);

const operacion2 = modOperaciones.multiplica(4,5);
console.log(chalk.green(operacion2));